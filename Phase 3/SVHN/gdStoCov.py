...
parser.add_argument('--iters', type=int, default=int(7000))
...
parser.add_argument('--logdir', type=str, default='MultiNoise-master/SVHN/logs/GDStoCov')
...
for i in range(start_iter, 7000, 100):
    # decay lr
