...
parser.add_argument('--iters', type=int, default=int(10000))
...
parser.add_argument('--logdir', type=str, default='MultiNoise-master/SVHN/logs/GGD')
...
for i in range(start_iter, 10000, 100):
    # decay lr
