...
parser.add_argument('--iters', type=int, default=int(2e4+1))
...
parser.add_argument('--logdir', type=str, default='MultiNoise-master/CIFAR10/logs/GD')
...
for i in range(start_iter, 30000, 100):
    # decay lr
