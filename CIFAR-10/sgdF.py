...
parser.add_argument('--iters', type=int, default=int(3e+4))
...
parser.add_argument('--datadir', type=str, default='MultiNoise-master/CIFAR10/numpy')
parser.add_argument('--logdir', type=str, default='MultiNoise-master/CIFAR10/logs/SGDFisher')
...
for i in range(start_iter, 80000, 100):
    # decay lr
